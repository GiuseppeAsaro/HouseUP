...
BOOKING_RESULT_CREATE_EXAMPLES = {
    "seller_flow": {
        ...
        "description": "Authenticated seller; seller_id is derived from token.",
        "value": {
    ...
    "admin_flow": {
        ...
        "description": "Authenticated admin; seller_id is required.",
        "value": {
            "booking_id": "42a3b8d123884bdba489c91edc0b3389",
            "booking_datetime": "2026-03-20T10:30:00Z",
            "buyer_id": "67bc9f6a4b5d2e12cfa4a933",
...
@router.post(
    ...
    description=(
        ...
        "All required house and interaction fields are provided by payload."
    ),
)
